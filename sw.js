const CACHE='elite-boss-atlas-v4-1';
const SHELL=['/','/index.html','/styles.css','/app.js','/config.js','/manifest.webmanifest','/assets/logo.svg','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
